(() => {
    ...
    function initSliders() {
        if (document.querySelector(".car-swiper__slider")) new core(".car-swiper__slider", {
        ...
        if (document.querySelector(".element-edge__slider")) new core(".element-edge__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            ...
            slidesPerView: "auto",
            pagination: {
                el: ".swiper-pagination-edge",
                type: "bullets",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-edge-prev",
                nextEl: ".swiper-edge-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: "auto",
